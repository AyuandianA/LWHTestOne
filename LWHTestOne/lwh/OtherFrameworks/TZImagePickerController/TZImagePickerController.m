...
- (void)configBarButtonItemAppearance {
    ...
    textAttrs[NSFontAttributeName] = [UIFont systemFontOfSize:TextFont];
...
- (void)configDefaultImageName {
    ...
    self.photoNumberIconImage = [self createImageWithColor:RGB(254, 92, 46, 1) size:CGSizeMake(24, 24) radius:12]; // @"photo_number_icon";
