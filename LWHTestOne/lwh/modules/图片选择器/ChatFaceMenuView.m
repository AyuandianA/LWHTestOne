...
@implementation ChatFaceMenuView
...
//    [self.addButton setFrame:CGRectMake(0, 0, w, self.frameHeight)];
    ...
    [line setBackgroundColor:[UIColor colorWithRed:188/255.0 green:188/255.0 blue:188/255.0 alpha:.6]];
...
- (void) buttonDown:(UIButton *)sender
{
    ...
    else
    {
        ...
        [sender setBackgroundColor:[UIColor colorWithRed:244/255.0 green:244/255.0 blue:246/255.0 alpha:1]];
...
- (void)setBtnType:(int)btnType {
    ...
    if (btnType == 1) {
        [_sendButton setTitle:@"收起" forState:UIControlStateNormal];
    } else {
        [_sendButton setTitle:@"发送" forState:UIControlStateNormal];
    }
}
