...
- (void)viewDidLoad {
    ...
    self.tableView.SourceArray  = @[@"公司的法国人同一天",@"r而台湾而对方公司的感受到",@"分公司答复公司法告诉对方公司法规的三个大公司的公司的股份第三个分公司答复公司法告诉对方公司法规的三个大公司的公司的股份第三个分公司答复公司法告诉对方公司法规的三个大公司的公司的股份第三个分公司答复公司法告诉对方公司法规的三个大公司的公司的股份第三个"].mutableCopy;
